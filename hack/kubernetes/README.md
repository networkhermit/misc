...
for i in $(kubeadm config images list --kubernetes-version "$(kubeadm version --output short)") registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.18.0 registry.k8s.io/metrics-server/metrics-server:v0.8.1; do
